from tango.ptrace import logger
from tango.ptrace.cpu_info import CPU_WORD_SIZE
from tango.ptrace.ctypes_tools import uint2int, formatWordHex, formatAddress
from tango.ptrace.signames import signalName
from tango.ptrace.errors import PTRACE_ERRORS, writeError
from tango.ptrace.func_arg import FunctionArgument
from tango.ptrace.syscall.posix_arg import (
    formatMmapProt, formatAccessMode, formatOpenFlags, formatCloneFlags, formatDirFd, formatOpenMode)
from tango.ptrace.func_call import FunctionCall
from tango.ptrace.syscall.socketcall import (setupSocketCall,
                                       formatOptVal, formatSockaddr, formatSockaddrInStruct, formatSockaddrIn6Struct)
from tango.ptrace.syscall.socketcall_constants import SOCKETCALL
from tango.ptrace.os_tools import RUNNING_LINUX, RUNNING_FREEBSD
from tango.ptrace.syscall import FILENAME_ARGUMENTS
from tango.ptrace.syscall.socketcall_constants import formatSocketType

if RUNNING_LINUX:
    from tango.ptrace.syscall.linux_struct import (
        timeval, timespec, pollfd, rlimit, new_utsname, user_desc)
    from tango.ptrace.syscall.linux_constants import SYSCALL_ARG_DICT, FD_SETSIZE
elif RUNNING_FREEBSD:
    from tango.ptrace.syscall.freebsd_constants import SYSCALL_ARG_DICT
else:
    SYSCALL_ARG_DICT = {}
