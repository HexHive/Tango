...
from tango.ptrace.ctypes_tools import ntoh_ushort, ntoh_uint  # noqa
from tango.ptrace.syscall import SYSCALL_PROTOTYPES
from tango.ptrace.syscall.socketcall_constants import SOCKETCALL, SOCKET_FAMILY  # noqa
from tango.ptrace.syscall.socketcall_struct import sockaddr, sockaddr_in, sockaddr_in6, sockaddr_un
from tango.ptrace.os_tools import RUNNING_LINUX
from socket import AF_INET, AF_INET6, inet_ntoa   # noqa
if RUNNING_LINUX:
    from tango.ptrace.syscall.socketcall_struct import sockaddr_nl
