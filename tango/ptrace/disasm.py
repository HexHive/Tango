...
try:
    from tango.ptrace.cpu_info import CPU_I386, CPU_X86_64
    try:
        ...
        DISTORM3 = False
        from tango.ptrace.pydistorm import Decode
        if CPU_X86_64:
            from tango.ptrace.pydistorm import Decode64Bits as DecodeBits
            MAX_INSTR_SIZE = 11
        elif CPU_I386:
            from tango.ptrace.pydistorm import Decode32Bits as DecodeBits
            MAX_INSTR_SIZE = 8
        else:
            raise ImportError("CPU not supported")
